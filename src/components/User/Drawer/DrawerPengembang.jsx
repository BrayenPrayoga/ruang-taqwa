...
const DrawerPengembang = ({ open, onClose }) => (
  ...
  >
    ...
    <div className='flex items-center justify-center gap-3'>
      {[
        {
          href: 'https://github.com/BrayenPrayoga',
          icon: Github,
          hoverBg: 'hover:bg-[#1e3a8a]',
        },
        {
          href: 'https://www.linkedin.com/in/brayen-prayoga-6a6269170/',
          icon: Linkedin,
          hoverBg: 'hover:bg-[#0077b5]',
        },
        {
          href: 'https://www.instagram.com/brayenprayoga',
          icon: Instagram,
          hoverBg: 'hover:bg-[#e1306c]',
        },
        {
          href: 'mailto:brayenprayoga41@gmail.com',
          icon: Mail,
